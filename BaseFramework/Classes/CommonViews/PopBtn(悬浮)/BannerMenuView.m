...
@interface BannerMenuView () <CAAnimationDelegate>
{
...
{
    if (!_bShowMenu)
        [_bannerIV setFrame:CGRectMake(_bannerIV.frame.origin.x, _bannerIV.frame.origin.y + 64, _bannerIV.frame.size.width - SCALESIZE, _bannerIV.frame.size.height - SCALESIZE)];
    if (!_bMoving)
    {
